...
# Load your pretrained YOLOv8 model (update with your path to the weights)
model = YOLO('C:\\Users\\dharm\\Downloads\\Software Engineering Lab\\Implementation\\best.pt')  # Update the path to your .pt file
...
test_image_path = 'C:\\Users\\dharm\\Downloads\\Software Engineering Lab\\Implementation\\test images\\download (2).jpeg'  # Update the path to your test image
